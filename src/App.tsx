                    ...
                    {resume.experience.map((exp, i) => {
                      ...
                      return (
                        ...
                        >
                          {/* Timeline dot */}
                          <div
                            className={`absolute -left-8 top-1 w-[26px] h-[26px] rounded-full flex items-center justify-center text-[10px] font-bold text-white shadow-lg transition-all duration-500 bg-gradient-to-br ${badge.from} ${badge.to} ${
                              animated.has(i) ? 'scale-100 opacity-100 shadow-[0_0_12px_rgba(59,130,246,0.4)]' : 'scale-0 opacity-0'
                            }`}
                          ...
                          {/* Card */}
                          <div
                            className={`rounded-xl p-4 md:p-5 transition-all duration-500 bg-slate-50 hover:bg-slate-100 dark:bg-slate-700/50 dark:hover:bg-slate-700 border border-slate-200/60 dark:border-slate-600/30 shadow-sm hover:shadow-md ${
                              animated.has(i) ? 'translate-x-0 opacity-100' : '-translate-x-6 opacity-0'
                            }`}
                            style={{ transitionDelay: `${i * 100}ms` }}
                          >
